...
class ReportController extends Controller
{
    ...
    public function bookingHistory()
    {
        ...
        $reports = DB::table('reports')
            ...
            ->select('orders.charge','orders.id', 'orders.duration_hour', 'orders.end_location', 'orders.created_at', 'orders.start_location', 'reports.id', 'reports.user_id', 'reports.car_id', 'reports.order_id', 'reports.firstname', 'reports.lastname', 'reports.mobile', 'reports.user_address', 'cars.id', 'cars.licenseplate', 'cars.make', 'cars.model', 'cars.address', 'cars.image', 'users.id', 'users.email', 'users.name')
